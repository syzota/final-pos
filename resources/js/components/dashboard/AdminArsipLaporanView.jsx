...
export default function AdminArsipLaporanView() {
    ...
    const handleCetakLaporan = (tipe, data) => {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                setIsPrinting(false);
                setPrintLaporanTarget({ type: '', data: null });
            }, 500);
        }, 150);
    };
    ...
    return (
        ...
        @media print {
          ...
          ${printLaporanTarget.type === 'rekap46' ? `
            ...
            #dokumen-cetak-rekap46, #dokumen-cetak-rekap46 * {
            ...
            .tabel-kegiatan th, .tabel-kegiatan td { border-color: #000 !important; }
          ` : ''}
          ...
          ${printLaporanTarget.type === 'rekap13' ? `
            ...
            /* Paksa warna hitam & putih, mengatasi teks/border yang jadi
               tak terlihat karena tertimpa reset CSS print global lain */
            #dokumen-cetak-rekap13, #dokumen-cetak-rekap13 * {
              visibility: visible !important;
              opacity: 1 !important;
              color: #000 !important;
              background-color: #fff !important;
            ...
            .tabel-laporan th, .tabel-laporan td { border-color: #000 !important; }
            .titik-titik, .garis-bawah { border-bottom-color: #000 !important; }
          ` : ''}
          ...
          ${printLaporanTarget.type === 'dataUmum' ? `
            ...
            /* Paksa warna hitam & putih, mengatasi teks/border yang jadi
               tak terlihat karena tertimpa reset CSS print global lain */
            #dokumen-cetak-dataumum, #dokumen-cetak-dataumum * {
              visibility: visible !important;
              opacity: 1 !important;
              color: #000 !important;
              background-color: #fff !important;
            ...
            .tabel-umum th, .tabel-umum td { border-color: #000 !important; }
            .titik-titik, .garis-bawah { border-bottom-color: #000 !important; }
          ` : ''}
        }
      `}</style>
                                    ...
                                    <tr key={posyandu.id}>
                                        ...
                                        <td style={{ textAlign: 'center' }}>
                                            <Button
                                                ...
                                                size="sm"
                                                icon={FolderOpenIcon}
                                                onClick={() => openDetailPosyandu(posyandu)}
                                            >
                                                Buka Arsip
                                            </Button>
                                        </td>
                ...
                {viewMode === 'detail' && selectedPosyandu && (
                    <div>
                        ...
                        <div className="card" style={{ backgroundColor: '#f8f9fa' }}>
                            ...
                            {/* TABS MENU */}
                            <div className="tabs" style={{ display: 'flex', gap: '8px', overflowX: 'auto', paddingBottom: '4px', marginBottom: '20px' }}>
                                {[
                                    { id: 0, label: 'Register Kegiatan (46 Kolom)', icon: File01Icon },
                                    { id: 1, label: 'Pencatatan 13 Poin (TTD)', icon: CheckListIcon },
                                    { id: 2, label: 'Data Umum Posyandu', icon: CheckListIcon }
                                ].map((tabItem) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            style={{
                                                ...
                                                fontWeight: 700,
                                                border: '1px solid',
                                                borderColor: isSelected ? 'var(--primary-teal, #008080)' : '#cbd5e1',
                            ...
                            {/* ISI KONTEN TAB */}
                            {isLoadingLaporan ? (
                                <Skeleton type="box" height="600px" style={{ width: '100%', marginBottom: '20px' }} />
                            ) : (
            ...
            {/* =========================================================================
          LAPORAN CETAK RAHASIA (DI-PORTAL LANGSUNG KE document.body AGAR LEPAS
          DARI WRAPPER DASHBOARD .shell/.main/.content SAAT window.print())
          ========================================================================= */}

            {/* 1. CETAK REKAP 46 KOLOM (LANDSCAPE) */}
            {isPrinting && printLaporanTarget.type === 'rekap46' && printLaporanTarget.data && ReactDOM.createPortal(
            ...
            {isPrinting && printLaporanTarget.type === 'rekap13' && printLaporanTarget.data && ReactDOM.createPortal(
            ...
            {isPrinting && printLaporanTarget.type === 'dataUmum' && printLaporanTarget.data && ReactDOM.createPortal(
